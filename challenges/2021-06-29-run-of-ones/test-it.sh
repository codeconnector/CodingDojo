...
run_test() {
    ...
    javac -d out -cp lib/junit-platform-console-standalone-1.8.0-M1.jar \
        src/main/java/io/codeconnector/codedojo/RunOfOnes.java \
        src/test/java/io/codeconnector/codedojo/RunOfOnesTest.java 
...
if (("$tests_failed" > 0)); then
    ...
    echo -e "    the solutions/[lanugage] folder, renaming it to [yourgithubusername.java]"
    ...
    echo -e "    that branch"
    echo -e "  - From your WIP branch, use ${YLW}git add solutions/java/yourgithubusername.java${CLR}"
