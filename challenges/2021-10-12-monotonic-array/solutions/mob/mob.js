...
function isMonotonic(array) {
    ...
    //did it increase AND did it decrease 
    //it hasn't happened yet
 let didItIncrease = false
 let didItDecrease = false
 //check each element in array and check previous element
 for (let i=0; i<array.length; i++) {
     ...
     if (didItIncrease && didItDecrease){
         return false
     }
 }
 return true
 //guard clause
//  return !(didItIncrease && didItDecrease)
